...
{
    /// <summary>
    ///     Constructs <see cref="BiometricAccuracyDescriptorJSON" />.
    /// </summary>
    /// <param name="selfAttestedFrr">
    ///     <para>
    ///         The false rejection rate <a href="https://www.iso.org/standard/73515.html">[ISOIEC-19795-1]</a> for a single template, i.e. the percentage of verification transactions with truthful claims of identity that are incorrectly denied. For example a FRR of 10% would be
    ///         encoded as 0.1.
    ///     </para>
    ///     <para>
    ...
    ///         <a href="https://fidoalliance.org/specs/biometric/requirements/Biometrics-Requirements-v4.1-fd-20250106.html">[FIDOBiometricsRequirements]</a> for the indicated biometric certification level (see certLevel in related biometricStatusReport as specified in
    ///         <a href="https://fidoalliance.org/specs/mds/fido-metadata-service-v3.1-ps-20250521.html#dom-biometricstatusreport-certlevel">[FIDOMetadataService]</a>).
    ///     </para>
    /// </param>
    /// <param name="selfAttestedFar">
    ///     <para>
    ///         The false acceptance rate <a href="https://www.iso.org/standard/73515.html">[ISOIEC-19795-1]</a> for a single template, i.e. the percentage of verification transactions with wrongful claims of identity that are incorrectly confirmed. For example a FAR of 0.002% would
    ...
    ///         <a href="https://fidoalliance.org/specs/biometric/requirements/Biometrics-Requirements-v4.1-fd-20250106.html">[FIDOBiometricsRequirements]</a> for the indicated biomeric certification level (see certLevel in related biometricStatusReport as specified in
    ///         <a href="https://fidoalliance.org/specs/mds/fido-metadata-service-v3.1-ps-20250521.html#dom-biometricstatusreport-certlevel">[FIDOMetadataService]</a>).
    ///     </para>
    /// </param>
    /// <param name="iaparThreshold">
    ///     <para>
    ///         Impostor Attack Presentation Accept Rate (IAPAR) is the proportion of impostor attack presentations using the same presentation attack instrument (PAI) species that result in accept
    ///         <a href="https://www.iso.org/obp/ui/#iso:std:iso-iec:30107:-3:ed-1:v1:en">[isoiec-30107-3]</a>. For biometric certification requirements
    ///         <a href="https://fidoalliance.org/specs/biometric/requirements/Biometrics-Requirements-v4.1-fd-20250106.html">[FIDOBiometricsRequirements]</a>, certification can be achieved for an IAPAR threshold of less than 7% OR less than 15% for each of the PAI species tested.
    ///     </para>
    ...
    /// </param>
    [JsonConstructor]
    public BiometricAccuracyDescriptorJSON(
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    [SuppressMessage("ReSharper", "InconsistentNaming")]
    public double? IaparThreshold { get; }
